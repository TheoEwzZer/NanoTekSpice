...
void nts::Gate4017::update()
{
    ...
    mPins[12] = mCounter < 5 ? nts::Tristate::TRUE : nts::Tristate::FALSE;
}
...
nts::Tristate nts::Gate4017::compute(const size_t pin)
{
    ...
    if ((mPins[13] == nts::Tristate::TRUE) && (pin13 == nts::Tristate::FALSE) && (mPins[14] == nts::Tristate::TRUE)) {
        condition1 = true;
    }
    if ((mPins[14] == nts::Tristate::FALSE) && (pin14 == nts::Tristate::TRUE) && (mPins[13] != nts::Tristate::TRUE)) {
        condition2 = true;
    }
