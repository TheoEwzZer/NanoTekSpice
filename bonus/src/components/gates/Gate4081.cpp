...
Tristate nts::Gate4081::getAnd(const Tristate link1, const Tristate link2) const
{
...
Tristate nts::Gate4081::compute(const size_t pin)
{
    ...
    if (pin == outputPin1) {
        ...
        mPins[outputPin1] = getAnd(link1, link2);
        ...
        mPins[outputPin2] = getAnd(link1, link2);
        ...
        mPins[outputPin3] = getAnd(link1, link2);
        ...
        mPins[outputPin4] = getAnd(link1, link2);
