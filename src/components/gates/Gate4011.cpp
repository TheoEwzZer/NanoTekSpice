...
Tristate nts::Gate4011::getNand(const Tristate link1,
    const Tristate link2) const
{
...
Tristate nts::Gate4011::compute(const size_t pin)
{
    ...
    if (pin == outputPin1) {
        ...
        mPins[outputPin1] = getNand(link1, link2);
        ...
        mPins[outputPin2] = getNand(link1, link2);
        ...
        mPins[outputPin3] = getNand(link1, link2);
        ...
        mPins[outputPin4] = getNand(link1, link2);
