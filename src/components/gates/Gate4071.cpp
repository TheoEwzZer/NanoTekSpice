...
Tristate nts::Gate4071::getOr(const Tristate link1, const Tristate link2) const
{
...
Tristate nts::Gate4071::compute(const size_t pin)
{
    ...
    if (pin == outputPin1) {
        ...
        mPins[outputPin1] = getOr(link1, link2);
        ...
        mPins[outputPin2] = getOr(link1, link2);
        ...
        mPins[outputPin3] = getOr(link1, link2);
        ...
        mPins[outputPin4] = getOr(link1, link2);
